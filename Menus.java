...
public class Menus {
    public class MainMenu extends Menu {
        public MainMenu() {
            ...
            buttons.add(new Button(MyGame.SCREEN_WIDTH / 2 - 75, 350, 150, 50, Color.GRAY, Color.DARK_GRAY, "Settings",
            ...
            buttons.add(new Button(MyGame.SCREEN_WIDTH - 175, MyGame.SCREEN_HEIGHT - 100, 150, 50, Color.GRAY,
                    Color.DARK_GRAY, "Account", new ButtonActions().new ViewAccount()));
            buttons.add(new Button(10, MyGame.SCREEN_HEIGHT - 100, 150, 50, Color.GRAY, Color.DARK_GRAY, "Leaderboard",
    ...
    public class ResultsMenu extends Menu {
        public ResultsMenu() {
            ...
            buttons.add(new Button(MyGame.SCREEN_WIDTH / 2 - 75, MyGame.SCREEN_HEIGHT - 175, 150, 50, Color.GRAY,
    ...
    public class SettingsMenu extends Menu {
        public SettingsMenu() {
            ...
            text.add(new Text("Settings", MyGame.SCREEN_WIDTH / 2 - 20, 48, Color.WHITE,
                    new Rectangle(0, 48, MyGame.SCREEN_WIDTH, 48)));
            text.add(new Text("Starting Level: " + MyGame.save.startLevel, MyGame.SCREEN_WIDTH / 2 - 75, 375,
                    Color.WHITE));
    ...
    public class ServerMenu extends Menu {
        public ServerMenu() {
            ...
            for (int i = 0; i < servers.size(); i++) {
                ...
                buttons.add(new Button(MyGame.SCREEN_WIDTH / 2 - 150, 100 + (i * 75), 300, 50, Color.GRAY,
                        Color.DARK_GRAY, doc.getString("name") + "'s Game",
                        new ButtonActions().new JoinServer(doc.getString("address"))));
            }

            buttons.add(new Button(10, MyGame.SCREEN_HEIGHT - 100, 150, 50, Color.GRAY, Color.DARK_GRAY, "Back to Menu",
    ...
    public class AccountMenu extends Menu {
        public AccountMenu() {
            ...
            text.add(new Text("Prestige: " + MyGame.account.prestige, MyGame.SCREEN_WIDTH / 2 - 20, 148, Color.WHITE,
                    new Rectangle(0, 148, MyGame.SCREEN_WIDTH, 48)));
            text.add(new Text("EXP: " + MyGame.account.exp + "/" + (50 + (MyGame.account.level * 50)),
                    MyGame.SCREEN_WIDTH / 2 - 20, 196, Color.WHITE, new Rectangle(0, 196, MyGame.SCREEN_WIDTH, 48)));
            text.add(new Text("Highest Level: " + MyGame.account.highestLevel, MyGame.SCREEN_WIDTH / 2 - 20, 244,
                    Color.WHITE, new Rectangle(0, 244, MyGame.SCREEN_WIDTH, 48)));

            if (MyGame.account.name.startsWith("Guest"))
                buttons.add(new Button(MyGame.SCREEN_WIDTH - 175, MyGame.SCREEN_HEIGHT - 100, 150, 50, Color.GRAY,
                        Color.DARK_GRAY, "Link Account", new ButtonActions().new LinkAccount()));
            else
                buttons.add(new Button(MyGame.SCREEN_WIDTH - 175, MyGame.SCREEN_HEIGHT - 100, 150, 50, Color.GRAY,
    ...
    public class LeaderboardMenu extends Menu {
        public LeaderboardMenu() {
            ...
            for (int i = 0; i < names.length; i++) {
                text.add(new Text(
                        names[i] + ": LVL " + levels[i] + " (Prestige: " + prestiges[i] + ") | Highest LVL: "
                                + highestLvl[i],
    ...
    public class MultiplayerMenu extends Menu {
        public MultiplayerMenu() {
            ...
            buttons.add(new Button(MyGame.SCREEN_WIDTH / 2 - 75, 200, 150, 50, Color.GRAY, Color.DARK_GRAY, "Host Game",
                    new ButtonActions().new Host()));
            buttons.add(new Button(MyGame.SCREEN_WIDTH / 2 - 75, 275, 150, 50, Color.GRAY, Color.DARK_GRAY, "Servers",
    ...
    public class ChallengeMenu extends Menu {
        public ChallengeMenu() {
            ...
            buttons.add(new Button(MyGame.SCREEN_WIDTH / 2 - 75, 200, 150, 50, Color.GRAY, Color.DARK_GRAY,
                    "Checkerboard", new ButtonActions().new StartChallenge(new CheckerboardChallenge())));
            buttons.add(new Button(MyGame.SCREEN_WIDTH / 2 - 75, 275, 150, 50, Color.GRAY, Color.DARK_GRAY, "Staircase",
            ...
            buttons.add(new Button(MyGame.SCREEN_WIDTH / 2 - 75, 350, 150, 50, Color.GRAY, Color.DARK_GRAY,
                    "Hard Checkboard", new ButtonActions().new StartChallenge(new HardCheckerboardChallenge())));
            buttons.add(new Button(MyGame.SCREEN_WIDTH / 2 - 75, 425, 150, 50, Color.GRAY, Color.DARK_GRAY, "X",
