...
public class Menus {
    ...
    public class ChallengeMenu extends Menu {
        public ChallengeMenu() {
            ...
            buttons.add(new Button(MyGame.SCREEN_WIDTH / 2 - 75, 350, 150, 50, Color.GRAY, Color.DARK_GRAY, "Hard Checkboard", new ButtonActions().new StartChallenge(new HardCheckerboardChallenge())));
            buttons.add(new Button(MyGame.SCREEN_WIDTH / 2 - 75, 425, 150, 50, Color.GRAY, Color.DARK_GRAY, "X", new ButtonActions().new StartChallenge(new XChallenge())));
            buttons.add(new Button(10, MyGame.SCREEN_HEIGHT - 100, 150, 50, Color.GRAY, Color.DARK_GRAY, "Back to Menu", new ButtonActions().new BackToMenu()));
        }
    }
}